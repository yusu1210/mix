...
describe("Mix product shell", () => {
  ...
  it.each([
    { active: "account-1", targetLabel: "beta@example.com", target: "account-3" },
    { active: "account-2", targetLabel: "alpha@example.com", target: "account-1" },
    ...
    accounts.apps[0].profiles = [
      { name: "account-1", label: "alpha@example.com", managed_account: true, has_credentials: true, auth_strategy: "local-file", file_count: 1, secret_count: 1, provider: { id: "openai", name: "OpenAI", official: true } },
      { name: "account-2", label: "Partner Gateway", managed_account: true, has_credentials: true, auth_strategy: "local-file", file_count: 1, secret_count: 1, provider: { id: "custom", name: "Partner Gateway", official: false } },
      { name: "account-3", label: "beta@example.com", managed_account: true, has_credentials: true, auth_strategy: "local-file", file_count: 1, secret_count: 1, provider: { id: "openai", name: "OpenAI", official: true } },
    ];
    mocks.request.mockImplementation(async (path: string, init?: RequestInit) => {
